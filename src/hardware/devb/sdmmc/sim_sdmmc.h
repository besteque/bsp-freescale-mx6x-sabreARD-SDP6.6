...
typedef struct _sdmmc_abilities {
	int     assd;
} SDMMC_ABILITIES;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/devb/sdmmc/sim_sdmmc.h $ $Rev: 813585 $")
#endif
