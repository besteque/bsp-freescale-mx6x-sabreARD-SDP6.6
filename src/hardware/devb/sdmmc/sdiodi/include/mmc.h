...
//Vendor specific registers - Micron
#define ECSD_MICRON_BOOT_SIZE_EXT0			125
#define ECSD_MICRON_BOOT_SIZE_EXT1			126
#define ECSD_MICRON_BOOT_SIZE_EXT2			127
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/devb/sdmmc/sdiodi/include/mmc.h $ $Rev: 813585 $")
#endif
