...
sdio_device_errata_t mmc_errata[] = {
	// Samsung devices
		// fw errata where device will discard data when AC12 is used
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/devb/sdmmc/sdiodi/mmc.c $ $Rev: 814796 $")
#endif
