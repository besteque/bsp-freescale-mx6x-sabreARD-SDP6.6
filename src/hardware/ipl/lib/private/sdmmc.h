...
extern void sdmmc_set_hc(sdmmc_t *sdmmc, unsigned base, unsigned clock, int verbose);
extern int sdmmc_select_bt_part_access(sdmmc_t *sdmmc, char part);
#endif /* #ifndef _SDMMC_H_ */


#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/ipl/lib/private/sdmmc.h $ $Rev: 795494 $")
#endif
