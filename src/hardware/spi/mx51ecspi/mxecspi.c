...
void *mx51_init(void *hdl, char *options)
{
	 ...
	 * mx51_chipsel uses dev->errata to work around a hardware errata. */
	if (dev->errata_en) {
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/spi/mx51ecspi/mxecspi.c $ $Rev: 811963 $")
#endif
