...
init_cacheattr()
{
	...
	unsigned l2_base = MX6X_PL310_BASE;
	unsigned reg_val;
	 ...
	 *
	 * NOTE: callouts currently flush the whole cache...
	 */
	system_icache_idx =
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/startup/boards/imx6x/init_cacheattr.c $ $Rev: 794468 $")
#endif
