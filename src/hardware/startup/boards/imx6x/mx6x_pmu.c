...
uint32_t pmu_set_voltage(uint32_t ldo_num, uint32_t req_voltage)
{
	...
	// future - add support for Internal Bypass mode which can be used for boards w/ external PMIC chips
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/startup/boards/imx6x/mx6x_pmu.c $ $Rev: 801720 $")
#endif
