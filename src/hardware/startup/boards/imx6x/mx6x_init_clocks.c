...
void mx6x_init_gpu3D(void)
{
	...
	else
	{
		...
		if (get_mx6_chip_rev() > MX6_CHIP_REV_1_1)
		{
			...
			if (get_mx6_chip_type() >= MX6_CHIP_REV_2_0)
			{
				/* 
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/startup/boards/imx6x/mx6x_init_clocks.c $ $Rev: 783570 $")
#endif
