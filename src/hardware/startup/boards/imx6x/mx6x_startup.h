...
#define MX6X_PAD_SETTINGS_ENET_REF_IN        (PAD_CTL_HYS_DISABLE | PAD_CTL_PUS_100K_PD | \
                                              PAD_CTL_PUE_PULL | PAD_CTL_PKE_ENABLE | PAD_CTL_ODE_DISABLE | \
                                              PAD_CTL_SPEED_MEDIUM | PAD_CTL_DSE_40_OHM | PAD_CTL_SRE_SLOW)

#define MX6X_PAD_SETTINGS_ENET_REF_OUT     (PAD_CTL_HYS_ENABLE | PAD_CTL_PUS_100K_PD | \
                                              PAD_CTL_PUE_PULL | PAD_CTL_PKE_ENABLE | PAD_CTL_ODE_DISABLE | \
                                              PAD_CTL_SPEED_MEDIUM | PAD_CTL_DSE_34_OHM | PAD_CTL_SRE_SLOW)
...
#define MX6X_PAD_SETTINGS_PWM       MX6X_PAD_SETTINGS_GENERAL
...
uint32_t mx6x_get_ecspi_clk(void);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/startup/boards/imx6x/mx6x_startup.h $ $Rev: 804160 $")
#endif
