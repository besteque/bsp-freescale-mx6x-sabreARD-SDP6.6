...
#ifndef __AARCH32_PSCI_H_INCLUDED
#define __AARCH32_PSCI_H_INCLUDED
 ...
 */
extern uint32_t	(*psci_call)(uint32_t __r0, uint32_t __r1, uint32_t __r2, uint32_t __r3);
extern uint32_t	psci_hvc(uint32_t __r0, uint32_t __r1, uint32_t __r2, uint32_t __r3);
extern uint32_t	psci_smc(uint32_t __r0, uint32_t __r1, uint32_t __r2, uint32_t __r3);
...
psci_cpu_suspend(uint32_t power_state, uintptr_t entry_point, uint32_t context_id)
{
...
static inline int32_t
psci_cpu_on(uint32_t target_cpu, uintptr_t entry_point, uint32_t context_id)
{
...
static inline int32_t
psci_cpu_default_suspend(uint32_t target_cpu, uintptr_t entry_point, uint32_t context_id)
{
...
static inline int32_t
psci_system_suspend(uintptr_t entry_point, uint32_t context_id)
{
...
#endif	/* __AARCH32_PSCI_H_INCLUDED */

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/startup/lib/public/arm/psci.h $ $Rev: 790264 $")
#endif
