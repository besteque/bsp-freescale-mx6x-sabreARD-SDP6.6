...
#define MX6X_WDOG_CR                            0x00
    #define MX6X_WDOG_CR_WDZST                  (0x01 << 0)
    #define MX6X_WDOG_CR_WDDBG                  (0x01 << 1)
    #define MX6X_WDOG_CR_WDE                    (0x01 << 2)
    #define MX6X_WDOG_CR_WDT                    (0x01 << 3)
    #define MX6X_WDOG_CR_SRS                    (0x01 << 4)
    #define MX6X_WDOG_CR_WDA                    (0x01 << 5)
    #define MX6X_WDOG_CR_SRE                    (0x01 << 6)
    #define MX6X_WDOG_CR_WDW                    (0x01 << 7)
    #define MX6X_WDOG_CR_WT                     (0xFF << 8)
...
#define MX6X_GPT_IRQ                            87

/*
 * GPT Registers, off set from base address
 */
#define MX6X_GPT_CR                             0x00    /* Control Register */
#define MX6X_GPT_PR                             0x04    /* Prescale Register */
#define MX6X_GPT_SR                             0x08    /* Status Register */
#define MX6X_GPT_IR                             0x0C    /* Interrupt Register */
#define MX6X_GPT_OCR1                           0x10    /* Output Compare Register 1 */
#define MX6X_GPT_OCR2                           0x14    /* Output Compare Register 2 */
#define MX6X_GPT_OCR3                           0x18    /* Output Compare Register 3 */
#define MX6X_GPT_ICR1                           0x1C    /* Input Capture Register 1 */
#define MX6X_GPT_ICR2                           0x20    /* Input Capture Register 2 */
#define MX6X_GPT_CNT                            0x24    /* Counter Register */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/startup/lib/public/arm/mx6x.h $ $Rev: 814531 $")
#endif
