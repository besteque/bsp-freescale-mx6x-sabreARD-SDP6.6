...
/*
 * ------------------------------------------------------------------
 * ADI ADSP-SC58X support
 * ------------------------------------------------------------------
 */

extern void	init_qtime_sc58x(unsigned base, unsigned clock, int intr);
...
extern void	init_sersc58x(unsigned, const char *, const char *);
extern void	put_sc58x(int);
extern struct callout_rtn	display_char_sc58x;
extern struct callout_rtn	poll_key_sc58x;
extern struct callout_rtn	break_detect_sc58x;

extern struct callout_rtn	reboot_sc58x;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/startup/lib/arm/cpu_startup.h $ $Rev: 801922 $")
#endif
