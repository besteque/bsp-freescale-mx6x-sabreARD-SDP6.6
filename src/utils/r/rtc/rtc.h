...
extern int init_mcp7940n(struct chip_loc *chip, char *argv[]);
extern int get_mcp7940n(struct tm *tm, int cent_reg);
extern int set_mcp7940n(struct tm *tm, int cent_reg);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/utils/r/rtc/rtc.h $ $Rev: 800931 $")
#endif
