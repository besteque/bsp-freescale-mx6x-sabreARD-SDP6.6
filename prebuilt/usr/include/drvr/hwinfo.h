...
unsigned	hwi_find_compatible(const char *compatible, int unit, unsigned hwi_off);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/lib/drvr/public/drvr/hwinfo.h $ $Rev: 780433 $")
#endif
