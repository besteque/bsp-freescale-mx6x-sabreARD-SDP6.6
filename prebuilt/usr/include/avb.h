...
#define DCMD_GET_CRS_STATUS	__DIOF(_DCMD_NET, 10, uint32_t )
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/lib/io-pkt/sys/lsm/avb/public/avb.h $ $Rev: 796078 $")
#endif
